...
## In Progress
- **Follow-up review fixes: reason matching and review totals refresh (CODEX, PR #597 OPEN 2026-07-18)** — Branch `codex/pr590-followup-review-fixes`; scoped to `app/src/admin/routes.ts`, `app/src/ui/dashboardHtml.ts`, and focused tests. Follow-up to merged PR #590; no merge/deploy/thread resolution per owner.
