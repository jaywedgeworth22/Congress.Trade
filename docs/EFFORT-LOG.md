...
## Completed
- **Remove agreement model globals / require explicit chamber lineups (CODEX, S) — MERGED PR #433 / PRODUCTION PENDING 2026-07-15.** Global agreement model values were removed from runtime/config/docs; House, Senate, and Executive A/B/C selections are explicit Infisical keys and incomplete lineups fail closed into human review. Local/preview gates and hosted CI are green; production ship follows this closeout.
