...
- **Switch to Cheapest OpenRouter Models (AG, S) — COMPLETED 2026-07-16.** Configured chamber-specific 3-model cascade matrices in wrangler.toml (House, Senate, and Exec) using different capability tiers based on file difficulty, leveraging the cheapest OpenRouter models, and deployed to production.
