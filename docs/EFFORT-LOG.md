...
- **Production benchmark failure diagnosis and reliability repair (CODEX + expert team, M) — LOCAL IMPLEMENTATION + ADVERSARIAL REVIEW COMPLETE / LANDING IN PROGRESS 2026-07-14 on `codex/benchmark-failure-repair-20260714`.** Production evidence isolates OpenAI GPT-5.6 project-access denial, Anthropic account cap through 2026-08-01 UTC, and depleted Gemini credits; GPT-4o/Mistral success rules out a shared document/Infisical failure. Repair adds durable House/Senate/Executive diagnostics and history, strict-document plus stable-row rescoring, actual measured cost coverage, success/failure latency separation, resumable/stoppable partial runs, OpenAI catalog readiness, invoked provider/per-model canaries, deterministic non-invoked fan-out, one-running-run-per-chamber admission, status-fenced claim/cancel/complete races, and full-coverage evidence gates before A/B/C settings promotion. Local pre-provider failures advance the canary. Focused 195/195, full 126 files / 1,243 tests, typecheck, quiet lint, local migrations through 0041, and diff check pass; independent final review reran 196 focused tests plus static gates and found no P0/P1/P2. No paid rerun, lineup save, production mutation, or Antigravity-checkout edit occurred. Next: commit, isolated preview, hosted PR gates, protected merge, canonical ship/migrate, live health/readiness, and D1-only rescore of interrupted House run `84da721d-aa57-4bec-b34c-ba6898e9fd06`.
