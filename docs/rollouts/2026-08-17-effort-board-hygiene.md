...
## Context & Objective
In Progress on the live Congress.Trade board still listed work that had already merged. Zero open PRs. GitHub effort issues stayed `state:in-progress` because the committed mirror had not moved those rows.
