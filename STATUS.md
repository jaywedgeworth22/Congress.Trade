...
- Deno Zod is aligned to v4.4.3 and the exact shared v2.0.0 source/tag commit is vendored with explicit provenance. Exact vendor comparison, Deno typecheck, 73 focused tests, and the full 156-file / 1,774-test suite pass. PR and Deno production receipts are pending.
