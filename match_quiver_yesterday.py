...
print("=== QUIVER OBSERVATIONS FILED/OBSERVED YESTERDAY OR TODAY ===")
q_rows = parse_html_table(run_sql("""
SELECT provider_key, trade_hash, filer_name, source_url, filed_date, first_observed_at, payload
...
print("Found", len(q_rows), "Quiver observations.")
for r in q_rows[:15]:
    print("KEY:", r[0], "HASH:", r[1], "FILER:", r[2], "FILED_DATE:", r[3], "OBSERVED:", r[4])
