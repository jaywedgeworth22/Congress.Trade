...
<main>
  ...
  <section class="view active" id="view-trends">
    ...
    <div class="disclaimer" id="trDisclaimer">
      <button class="disclaimer-toggle" type="button" onclick="toggleDisclaimer()" aria-expanded="true" aria-controls="trDisclaimerBody"><span class="dt-label">Disclaimer:&nbsp; For Educational Uses (NOT Investment Advice)&nbsp; ↓</span><span class="dt-chevron" aria-hidden="true">▾</span></button>
