...
var FEED_COLS = [
  ...
  { id: 'chamber', label: 'Chamber', sort: 'chamber', def: true, cls: 'muted', tip: 'House or Senate source chamber.', cell: function (r) { return clipTextHtml(ownerLabel(r.chamber)); } },
...
var COL_ORDER_KEY = 'feed-cols-order-v2';
