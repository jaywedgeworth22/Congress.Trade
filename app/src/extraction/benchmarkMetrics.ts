...
export const STANDARD_BENCHMARK_RATE_CARD = [
  ...
  },
  {
    ...
    version: 'openrouter-static-2026-07-19',
    effectiveDate: '2026-07-19',
    sourceUrl: 'https://openrouter.ai/docs#models',
    note: 'OpenRouter passthrough of Anthropic Claude Opus 4.8 pricing; verified against the live /api/v1/models listing 2026-07-19.',
  },
  {
    provider: 'openrouter',
  ...
  },
  {
    ...
    effectiveDate: '2026-08-14',
    sourceUrl: 'https://openrouter.ai/docs#models',
    note: 'OpenRouter Gemini 3.7 Flash batch/offline pricing; verified against the live /api/v1/models listing 2026-08-14.',
  },
  {
    provider: 'openrouter',
  ...
  },
  {
    ...
    version: 'openrouter-static-2026-07-22',
    effectiveDate: '2026-07-22',
    sourceUrl: 'https://openrouter.ai/docs#models',
    note: 'OpenRouter Grok 4.5 pricing ($2/$6 per 1M; cache $0.30; 2x input/output above 200K prompt tokens). Verified against live /api/v1/models listing 2026-07-22. Token pricing is complete on this transport — the direct-xAI attachment_search surcharge does not apply via OpenRouter.',
  },
  {
    provider: 'openrouter',
