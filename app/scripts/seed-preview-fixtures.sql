...
INSERT OR IGNORE INTO transactions
  (id, doc_id, filer_id, tx_date, owner, asset_name, ticker, asset_type, tx_type, amount_min, amount_max, is_option, cap_gains_over_200, raw_text, confidence, source, created_at, cursor_seq)
VALUES
  ('preview-pelosi-intc', 'PREVIEW-H-20034836', 'P000197', '2026-05-29', 'spouse', 'Intel Corporation - Common Stock (INTC) [OP]', 'INTC', 'OP', 'P', 1000001, 5000000, 1, 0, 'Purchased 200 call options with a strike price of $50 and an expiration date of 3/19/27.', 0.99, 'primary', '2026-06-24T13:05:00Z', 900001),
  ('preview-pelosi-uber', 'PREVIEW-H-20034836', 'P000197', '2026-05-29', 'spouse', 'Uber Technologies, Inc. Common Stock (UBER) [OP]', 'UBER', 'OP', 'P', 500001, 1000000, 1, 0, 'Purchased 200 call options with a strike price of $50 and an expiration date of 3/19/27.', 0.99, 'primary', '2026-06-24T13:06:00Z', 900002),
  ('preview-perdue-axta', 'PREVIEW-S-PERDUE', 'P000449', '2026-06-20', 'self', 'Axalta Coating Systems Ltd.', 'AXTA', 'ST', 'P', 1001, 15000, 0, 0, '', 1.0, 'primary', '2026-06-21T08:02:00Z', 900003),
  ('preview-scott-bond', 'PREVIEW-S-SCOTT', 'S001217', '2019-10-16', 'self', 'Obligation Bond Rate/Coupon: 4.0% Matures: 07/01/2038', NULL, 'BO', 'P', 100001, 250000, 0, 0, '', 0.95, 'seed_dataset', '2026-06-21T15:35:00Z', 900004);
