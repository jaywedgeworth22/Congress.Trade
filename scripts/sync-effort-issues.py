...
# whole sync. Listing every issue with state=all pulls ~700KB across pages, so
# a single mid-body disconnect was enough to fail the run
# ("IncompleteRead(714456 bytes read, 6207 more expected)").
#
